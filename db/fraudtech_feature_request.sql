...
START TRANSACTION;
USE `fraudtech_feature_request`;
INSERT INTO `fraudtech_feature_request`.`people` (`login`, `firstName`, `lastName`, `contactInfo`, `notes`) VALUES ('Placeholder1', 'Bob', 'Barker', 'Bob@barker.com', 'He is purple');
INSERT INTO `fraudtech_feature_request`.`people` (`login`, `firstName`, `lastName`, `contactInfo`, `notes`) VALUES ('Placeholder2', 'Jenny', 'Smith', 'Jenny@smith.com', 'She likes hair');
